...
const ChefSection = ( ) =>{
  ...
  <div>
      <div>
        ...
        <div className="col-md-1 position-relative disNone "> 
        <div className="position-absolute top-0 start-50 translate-middle-x disNone"> <Image height={100} src={icon4}  alt="arrow"/> </div>
          
        </div>
        <div className="col-md-7 ChefMArgin paddingLaft">
            <div>
